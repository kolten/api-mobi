  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {id: 1, first_name: 'Kolten', last_name: 'Sturgill', student_id: '1001089599', email: 'kolten.sturgill@mavs.uta.edu', password: '$2a$10$y9t1Noglwg55acUzBeuAVeTg8/zHKfNNZo9iUsWGeqZc5keQOJUri', is_admin: true},
